...
departments = {
    ...
    9: Department(9, "Books",
                  [Product("Game of Thrones", 10), Product("Working in Public", 25), Product("Twilight", 10)]),
    13: Department(13, "Electronics",
                   [Product("Samsung 4K TV", 300), Product("iPhone SE", 400), Product("Pixel 4A", 350)]),
    7: Department(7, "Clothes",
                  [Product("Graphic T's", 20), Product("Kanye Sweater", 700), Product("Sketchers High Tops", 50)]),
    15: Department(15, "Toys", [Product("Lightsaber", 200), Product("Nerf Guns", 200), Product("Settlers of Catan", 40),
                                Product("Nintendo Lego Set", 150)])
}
